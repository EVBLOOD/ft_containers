...
//   std::cout << "int, const int: " << ft::is_same<int, const int>::value << std::endl;
//   std::cout << "int, integer_type: " << ft::is_same<int, integer_type>::value << std::endl;
//   std::cout << "A, B: " << ft::is_same<A,B>::value << std::endl;
//   std::cout << "A, C: " << ft::is_same<A,C>::value << std::endl;
//   std::cout << "signed char, std::int8_t: " << ft::is_same<signed char,std::int8_t>::value << std::endl;
//   return 0;
// }
...
int main() {
  ...
  // return 0;
  // STATIC_ASSERT(ft::is_integral<int>::value, "rest");
}
